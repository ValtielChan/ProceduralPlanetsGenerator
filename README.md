...
<p align="center">
  <img src="Documentation~/images/earth-biomes.png" width="49%" alt="Climate-driven Whittaker biomes and a polar cap">
  <img src="Documentation~/images/earth-clouds.png" width="49%" alt="Cloud shell with domain-warped detail and swirls">
</p>

<sub>The bundled **Earth** preset, straight out of the generator — GPU backend,
1024&nbsp;cubemaps, exported as one LOD prefab. Ocean-only specular sunglint,
separate cloud shell, climate-driven biomes.</sub>
