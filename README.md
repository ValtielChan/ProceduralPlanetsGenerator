...
![Earth-like terrestrial planet generated by the tool](Documentation~/images/earth-hero.png)

<p align="center">
  <img src="Documentation~/images/moon-hero.png" width="49%" alt="Rocky airless body — cratered surface, triplanar detail">
  <img src="Documentation~/images/gasgiant-hero.png" width="49%" alt="Gas giant — zonal bands, curl flow, storm ovals">
</p>
<p align="center">
  <img src="Documentation~/images/star-hero.png" width="49%" alt="Star — granulated photosphere, sunspots, HDR bloom">
  <img src="Documentation~/images/earth-clouds.png" width="49%" alt="Terrestrial cloud shell with domain-warped detail">
</p>
